...
account_info = ('Shalini', 'zxy12345', '123456fsdg', [300,],input("Enter the credit or debit action: "))
#amount = int(input("Enter the amount: "))

account_info[3][0]=account_info[-1] == "credit" and  account_info[3][0] - int(input("Enter the credit amount: ")) or  account_info[3][0] - int(input("Enter the debit amount: ")) 
